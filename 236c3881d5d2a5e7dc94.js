/*! For license information please see 236c3881d5d2a5e7dc94.js.LICENSE.txt */
function _typeof(e) {
    return (
      (_typeof =
                ...
                case 0:
                  return (
                    ...
                    Excel.run(
                                ...
                                switch ((e.prev = e.next)) {
                                  case 0:
                                    if (
                                      (globalVar.debug &&
                                        console.log(
                                          "Initialisation du classeur : Désactivation du calcul automatique"
                                        ),
                                      (t.application.calculationMode =
                                  ...
                                  case 18:
                                    return (
                                      handleButtonDisplay(o.name),
                                      (e.next = 21),
                                      t.sync()
                                    );
                                  case 21:
                                    globalVar.debug &&
                                      console.log("Calcul automatique désactivé");
                                  case 23:
                                  case "end":
                                    return e.stop();
                                }
                      ...
                      console.error(
                        "Erreur lors de l'initialisation du classeur : " + e
                      ),
                        e instanceof OfficeExtension.Error &&
                          console.error(
                            "Error globalVar.debug info: " +
  ...
  globalVar.debug && console.log(globalVar.isProcessing),
    Office.onReady(function (e) {
      e.host === Office.HostType.Excel &&
        (globalVar.debug &&
          console.log(
            "Office est prêt, chargement de la fonction qui se déclenche s'il y a un changement sur le fichier"
          ),
        initializeWorkbookSettings(),
        addWorksheetChangeHandler(),
        initializeButton());
    });
                              ...
                              for (;;)
                                switch ((e.prev = e.next)) {
                                  case 0:
                                    return (
                                      (n =
                                        t.workbook.worksheets.getActiveWorksheet()),
                                      (e.next = 3),
                                      n.load("name")
                                    );
                                  case 3:
  ...
  function addWorksheetChangeHandler() {
    Excel.run(
              ...
              for (;;)
                switch ((e.prev = e.next)) {
                  case 0:
                    return (
                      globalVar.debug &&
                        console.log("Ajout du gestionnaire de boutons."),
                      (n = t.workbook.worksheets.getActiveWorksheet()),
                      (e.next = 4),
                      n.load("name")
                    );
                  case 4:
                  ...
                  case 6:
                    globalVar.debug &&
                      ...
                      (r = t.workbook.worksheets.getItem(
                        "2. Planning - Consultant"
                      )).onActivated.add(ActivationPlanningConsultant),
                      r.onChanged.add(ChgtFeuilleConsultant),
                      globalVar.debug &&
                        console.log("Chargement des fonctions de la feuille", r),
                      (o = t.workbook.worksheets.getItem(
                        "2. Planning - Missions"
                      )).onActivated.add(ActivationPlanningMission),
                      o.onChanged.add(ChgtFeuilleMission),
                      globalVar.debug &&
                        console.log("Chargement des fonctions de la feuille", o),
                      (a = t.workbook.worksheets.getItem(
                        "3. Planning - Encadrant"
                      )).onActivated.add(ActivationPlanningEncadrant),
                      a.onChanged.add(ChgtFeuilleEncadrant),
                      globalVar.debug &&
                        console.log("Chargement des fonctions de la feuille", a),
                      (i = t.workbook.worksheets.getItem(
                        "3. Planning - Global"
                      )).onActivated.add(ActivationPlanningGlobal),
                      i.onChanged.add(ChgtFeuilleGlobal),
                      globalVar.debug &&
                        console.log("Chargement des fonctions de la feuille", i),
                      (c =
                        t.workbook.worksheets.getItem(
                          "3. Recap"
                        )).onActivated.add(ActivationRecap),
                      globalVar.debug &&
                        console.log("Chargement des fonctions de la feuille", c),
                      (s = t.workbook.worksheets.getItem(
                        "1. Liste des missions"
                      )).onActivated.add(ActivationListeMissions),
                      globalVar.debug &&
                        console.log("Chargement des fonctions de la feuille", s),
                      globalVar.debug &&
                        console.log("Gestionnaire de changement ajouté.");
                  case 38:
                  case "end":
                    return e.stop();
                }
      ...
      console.error("Erreur : " + e),
        e instanceof OfficeExtension.Error &&
          console.error(
            "Error globalVar.debug info: " + JSON.stringify(e.debugInfo)
          );
    });
  }
    ...
    try {
      document.querySelectorAll("section").forEach(function (e) {
        ...
        "1. Liste des missions" === e
          ? ((document.getElementById("sec-btn-AjoutMission").style.display =
              "flex"),
            (document.getElementById("sec-btn-Suppression").style.display =
              "flex"))
          ...
          ? ((document.getElementById("sec-btn-AjoutMission").style.display =
            ...
            (document.getElementById(
              "sec-btn-ModifierAffectationMission"
            ).style.display = "flex"))
          : "2. Planning - Consultant" === e &&
            ...
            (document.getElementById("sec-btn-Suppression").style.display =
              "flex"),
            (document.getElementById(
              "sec-btn-ModifierAffectationConsultant"
            ).style.display = "flex"));
    } catch (e) {
  ...
  function initializeButton() {
    document
      .getElementById("btn-AjoutMission")
      .addEventListener("click", handleClick),
      document
        .getElementById("btn-Suppression")
        .addEventListener("click", handleClick),
      document
        .getElementById("btn-ModifierAffectationMission")
        .addEventListener("click", handleClick),
      document
        .getElementById("btn-ModifierAffectationConsultant")
        .addEventListener("click", handleClick),
                ...
                case 0:
                  return (
                    ...
                    Excel.run(
                                ...
                                switch ((e.prev = e.next)) {
                                  case 0:
                                    return (
                                      (globalVar.debug = !0),
                                      (a = o.workbook),
                                      (i = a.worksheets.getItem("Suivi Modif")),
                                      (e.next = 5),
                                      i.load("name")
                                    );
                                  case 5:
                                    return (
                                      (c = i.getRange("A:A").getUsedRange()),
                                      (e.next = 8),
                                      c.load("rowCount")
                                    );
                                  case 8:
                                  ...
                                  case 10:
                                    return (
                                      ...
                                      globalVar.debug &&
                                        console.log(
                                          "Nombre de lignes utilisées dans wsSuivi :",
                                          s
                                        ),
                                      ...
                                      Office.context &&
                                      Office.context.user &&
                                      Office.context.user.displayName
                                        ? (l = Office.context.user.displayName)
                                        : console.warn(
                                            "Impossible de récupérer le nom de l'utilisateur."
                                          ),
                                      (e.next = 21),
                                      o.sync()
                                    );
                                  case 21:
                                    (i.getCell(s - 1, 3).values = [[l]]),
                                      (u = new Date()),
                                      (f = ""
                                        .concat(
                                        ...
                                        .concat(
                                          String(u.getSeconds()).padStart(2, "0")
                                        )),
                                      (i.getCell(s - 1, 4).values = [[f]]),
                                      globalVar.debug &&
                                        console.log(
                                          "Informations de suivi ajoutées pour la ligne :",
                                          s
                                        ),
                                      (globalVar.debug = !0);
                                  case 28:
                      ...
                      (globalVar.debug = !0),
                        console.error(
                          "Erreur lors l'ajout du suivi des modifications : " + e
                        ),
                        e instanceof OfficeExtension.Error &&
                          console.error(
                            "Error globalVar.debug info: " +
                ...
                case 0:
                  return (
                    ...
                    Excel.run(
                                ...
                                switch ((e.prev = e.next)) {
                                  case 0:
                                    return (
                                      ...
                                      globalVar.debug &&
                                        console.log(
                                          "Activation de la feuille 3. Recap"
                                        ),
                      ...
                      (globalVar.debug = !0),
                        console.error(
                          "Erreur lors de l'exécution de ActivationRecap :",
                          e
                        ),
                        e instanceof OfficeExtension.Error &&
                          console.error(
                ...
                case 0:
                  return (
                    ...
                    Excel.run(
                                ...
                                switch ((e.prev = e.next)) {
                                  case 0:
                                    return (
                                      ...
                                      globalVar.debug &&
                                        console.log(
                                          "Activation de la feuille 1. Liste des missions"
                                        ),
                                      ((n = t.application).screenUpdating = !1),
                                      n.calculate(),
                                      (e.next = 8),
                      ...
                      (globalVar.debug = !0),
                        console.error(
                          "Erreur lors de l'exécution de ActivationListeMissions :",
                          e
                        ),
                        e instanceof OfficeExtension.Error &&
                          console.error(
