  /*! For license information please see 236c3881d5d2a5e7dc94.js.LICENSE.txt */function _typeof(e) {
    ...
    function _regeneratorRuntime() {
      ...
      ,n = Object.prototype,r = n.hasOwnProperty,o = Object.defineProperty || function(e,t,n) {
        e[t]=n.value
      }
      ,a = "function "== typeof Symbol ? Symbol :  {
      }
      ,i = a.iterator || "@@iterator",c = a.asyncIterator || "@@asyncIterator",s = a.toStringTag || "@@toStringTag";
      function l(e,t,n) {
      ...
      ,"")}
        ...
        l = function(e,t,n) {
          ...
          var a = t && t.prototype instanceof m ? t:m,i = Object.create(a.prototype),c = new R(r || []);
          return o(i,"_invoke", {
          value : S(e,n,c)}
          ),i
        }
        function f(e,t,n) {
          ...
          t.wrap = u;
          var d = "suspendedStart",g = "suspendedYield",h = "executing",p = "completed",y =  {
          }
          ;
          function m() {
          }
          ...
          var w = Object.getPrototypeOf,_ = w && w(w(V([])));
            ...
            function S(t,n,r) {
              ...
              return function(a,i) {
                ...
                function V(t) {
                  ...
                  ,t.mark = function(e) {
                    return Object.setPrototypeOf ? Object.setPrototypeOf(e,b) : (e.__proto__ = b,l(e,s,"GeneratorFunction")),e.prototype = Object.create(E),e
                  }
                  ,t.awrap = function(e) {
                    return {
                      __await : e
                          ...
                          --a) {
                              ...
                              --t) {
                                ...
                                ,delegateYield : function(t,n,r) {
                                  return this.delegate =  {
                                    iterator : V(t),resultName : n,nextLoc : r
                                  }
                            ...
                            function _asyncToGenerator(e) {
                              return function() {
                                ...
                                ActivationPlanningConsultant,modifPlanningConsultant,ChgtFeuilleConsultant
                              }
                              from"./1_ModifConsultants.js";
                              import {
                                ActivationPlanningMission,modifPlanningMission,ChgtFeuilleMission
                              }
                              from"./2_ModifMissions.js";
                              import {
                                ActivationPlanningGlobal,ChgtFeuilleGlobal
                              }
                              from"./3_PlanningGlobal.js";
                              import {
                                ActivationPlanningEncadrant,ChgtFeuilleEncadrant
                              }
                              from"./3_PlanningEncadrant.js";
                              import {
                                formatProtection,formatMissions,formatConsultants,formatSemaine,applyNewRangeToConditionnalFormat
                              }
                              from"./0_Format.js";
                              import {
                                handleClick,nouvelleMission,suppressionMission,affectationMission,affectationConsultant
                              }
                              from"./0_Gestion_des_boutons.js";
                              export var globalVar =  {
                                debug : !1,isProcessing : !1,nbExecModifConsultant : 1,nbExecModifMission : 1,nbExecModifEncadrant : 1,nbExecModifGlobal : 1
                              }
                              ;
                                ...
                                return _initializeWorkbookSettings = _asyncToGenerator(_regeneratorRuntime().mark((function e() {
                                  return _regeneratorRuntime().wrap((function(e) {
                                    ...
                                    ;)switch(e.prev = e.next) {
                                      case 0 : return e.next = 2,Excel.run(function() {
                                        var e = _asyncToGenerator(_regeneratorRuntime().mark((function e(t) {
                                          var n,r,o;
                                          return _regeneratorRuntime().wrap((function(e) {
                                            for(;
                                            ;)switch(e.prev = e.next) {
                                              case 0 : if(globalVar.debug && console.log("Initialisation du classeur : Désactivation du calcul automatique"),t.application.calculationMode = Excel.CalculationMode.manual,!globalVar.debug) {
                                                e.next = 10;
                                                break
                                              }
                                              return n = t.application,e.next = 7,n.load("calculationState");
                                              case 7 : return e.next = 9,t.sync();
                                              case 9 : console.log("calculationState initial",n.calculationState);
                                              case 10 : return r = t.workbook,globalVar.debug && console.log(r),r.worksheets.onActivated.add(handleSheetChange),o = r.worksheets.getActiveWorksheet(),e.next = 16,o.load("name");
                                              case 16 : return e.next = 18,t.sync();
                                              case 18 : return handleButtonDisplay(o.name),e.next = 21,t.sync();
                                              case 21 : globalVar.debug && console.log("Calcul automatique désactivé");
                                            ...
                                            case 0 : return e.next = 2,Excel.run(function() {
                                              var e = _asyncToGenerator(_regeneratorRuntime().mark((function e(t) {
                                                ...
                                                return _regeneratorRuntime().wrap((function(e) {
                                                  for(;
                                                  ;)switch(e.prev = e.next) {
                                                    case 0 : return n = t.workbook.worksheets.getActiveWorksheet(),e.next = 3,n.load("name");
                                                    case 3 : return e.next = 5,t.sync();
                                                    case 5 : handleButtonDisplay(n.name);
                                                      ...
                                                      case 0 : return e.next = 2,Excel.run(function() {
                                                        var e = _asyncToGenerator(_regeneratorRuntime().mark((function e(o) {
                                                          ...
                                                          return _regeneratorRuntime().wrap((function(e) {
                                                            for(;
                                                            ;)switch(e.prev = e.next) {
                                                              case 0 : return globalVar.debug = !0,a = o.workbook,i = a.worksheets.getItem("Suivi Modif"),e.next = 5,i.load("name");
                                                              case 5 : return c = i.getRange("A : A").getUsedRange(),e.next = 8,c.load("rowCount");
                                                              case 8 : return e.next = 10,o.sync();
                                                              case 10 : return s = c.rowCount+1,globalVar.debug && console.log("Nombre de lignes utilisées dans wsSuivi : ",s),i.getCell(s - 1,0).values = [[t]],i.getCell(s - 1,1).values = [[n]],i.getCell(s - 1,2).values = [[r]],l = "Utilisateur inconnu",globalVar.debug && console.log("Office.context : ",Office.context),Office.context && Office.context.user && Office.context.user.displayName ? l=Office.context.user.displayName : console.warn("Impossible de récupérer le nom de l'utilisateur."),e.next = 21,o.sync();
                                                              case 21 : i.getCell(s - 1,3).values = [[l]],u = new Date,f = "".concat(String(u.getDate()).padStart(2,"0")," / ").concat(String(u.getMonth()+1).padStart(2,"0")," / ").concat(u.getFullYear()," ").concat(String(u.getHours()).padStart(2,"0")," : ").concat(String(u.getMinutes()).padStart(2,"0")," : ").concat(String(u.getSeconds()).padStart(2,"0")),i.getCell(s - 1,4).values = [[f]],globalVar.debug && console.log("Informations de suivi ajoutées pour la ligne : ",s),globalVar.debug = !0;
                                                            ...
                                                            case 0 : return e.next = 2,Excel.run(function() {
                                                              var e = _asyncToGenerator(_regeneratorRuntime().mark((function e(t) {
                                                                ...
                                                                return _regeneratorRuntime().wrap((function(e) {
                                                                  for(;
                                                                  ;)switch(e.prev = e.next) {
                                                                    case 0 : return globalVar.debug = !1,globalVar.debug && console.log("Activation de la feuille 3. Recap"),(n = t.application).screenUpdating = !1,n.calculate(),e.next = 8,formatSemaine("3. Recap",3);
                                                                    case 8 : return n.screenUpdating = !0,e.next = 11,t.sync();
                                                                    case 11 : globalVar.debug = !0;
                                                                  ...
                                                                  case 0 : return e.next = 2,Excel.run(function() {
                                                                    var e = _asyncToGenerator(_regeneratorRuntime().mark((function e(t) {
                                                                      ...
                                                                      return _regeneratorRuntime().wrap((function(e) {
                                                                        for(;
                                                                        ;)switch(e.prev = e.next) {
                                                                          case 0 : return globalVar.debug = !1,globalVar.debug && console.log("Activation de la feuille 1. Liste des missions"),(n = t.application).screenUpdating = !1,n.calculate(),e.next = 8,formatSemaine("1. Liste des missions",3);
                                                                          case 8 : return n.screenUpdating = !0,e.next = 11,t.sync();
                                                                          case 11 : globalVar.debug = !0;
                                                                        case 12 : case"end" : return e.stop()}
                                                                      }),e)}
