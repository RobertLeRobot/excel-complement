/*! For license information please see commands.9bb116161ca4a008b92a.js.LICENSE.txt */
(() => {
    "use strict";
    var t = {};
    ...
    function r() {
        ...
        }, P(_.prototype), f(_.prototype, l, (function() {
            return this
        ...
        }, P(k), f(k, s, "Generator"), f(k, u, (function() {
            return this
    ...
    var i = "ms-excel:ofe|u|https://actuelia.sharepoint.com/:x:/r/sites/Planning-Dev/_layouts/15/Doc.aspx?sourcedoc=%7B92B818C0-9252-468E-B871-0127854FC9F7%7D&file=Planning%20-%20vDev.xlsx&action=default&mobileredirect=true",
        a = !1;
    ...
    function u() {
        return u = o(r().mark((function t(e) {
            return r().wrap((function(t) {
                for (;;) switch (t.prev = t.next) {
                    case 0:
                        ...
                        return null != e && e.completed && e.completed(), t.abrupt("return");
                    case 3:
                        return a = !0, t.prev = 4, t.next = 7, Excel.run(function() {
                    ...
                    case 7:
                        ...
                        break;
                    case 9:
                        t.prev = 9, t.t0 = t.catch(4), console.error("Erreur dans openPlanningFile:", t.t0), window.open(i, "_blank");
                    case 13:
                        return t.prev = 13, a = !1, null != e && e.completed && e.completed(), t.finish(13);
                    case 17:
                    case "end":
                        return t.stop()
                }
    ...
    Office.onReady((function() {
        ...
        try {
            ...
            sessionStorage.getItem(t) || (sessionStorage.setItem(t, "1"), c())
        } catch (t) {
            c()
        }
    })), Office.actions.associate("openPlanningFile", c)
})();