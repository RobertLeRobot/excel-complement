/*! For license information please see commands.e4d5e88b8c1c50d19340.js.LICENSE.txt */
(() => {
    function t(r) {
    ...
    function r() {
        ...
        var L = Object.getPrototypeOf,
            O = L && L(L(T([])));
        O && O !== o && i.call(O, u) && (E = O);
        var P = x.prototype = w.prototype = Object.create(E);
        ...
        function j(t, r) {
            var n = r.method,
                o = t.iterator[n];
            if (o === e) return r.delegate = null, "throw" === n && t.iterator.return && (r.method = "return", r.arg = e, j(t, r), "throw" === r.method) || "return" !== n && (r.method = "throw", r.arg = new TypeError("The iterator does not provide a '" + n + "' method")), m;
        ...
        return b.prototype = x, a(P, "constructor", {
            value: x,
            configurable: !0
        }), a(x, "constructor", {
            value: b,
            configurable: !0
        }), b.displayName = f(x, s, "GeneratorFunction"), n.isGeneratorFunction = function(t) {
            var r = "function" == typeof t && t.constructor;
            return !!r && (r === b || "GeneratorFunction" === (r.displayName || r.name))
        }, n.mark = function(t) {
            return Object.setPrototypeOf ? Object.setPrototypeOf(t, x) : (t.__proto__ = x, f(t, s, "GeneratorFunction")), t.prototype = Object.create(P), t
        }, n.awrap = function(t) {
            return {
                __await: t
            }
        }, k(_.prototype), f(_.prototype, l, (function() {
            return this
        ...
        }, k(P), f(P, s, "Generator"), f(P, u, (function() {
            return this
    ...
    function o() {
        return o = n(r().mark((function t(e) {
            return r().wrap((function(t) {
                for (;;) switch (t.prev = t.next) {
                            ...
                            var t = n(r().mark((function t(e) {
                                ...
                                return r().wrap((function(t) {
                                    for (;;) switch (t.prev = t.next) {
                                        ...
                                        case 4:
                                            if ("PlanningActuelia" === n.title) console.log("Fichier de planning détecté — ouverture du volet."), Office.addin.showAsTaskpane();
                                            else {
                                                console.log("✅ Bouton cliqué : tentative d'ouverture du fichier SharePoint."), o = "ms-excel:ofe|u|https://actuelia.sharepoint.com/:x:/r/sites/Planning/_layouts/15/Doc.aspx?sourcedoc=%7BC220647B-6855-4B92-BCE5-6BE318279806%7D&file=Planning%20-%20v11.xlsx&action=default&mobileredirect=true";
                                                try {
                                                    console.log("🔗 Ouverture du fichier SharePoint :", o), window.location.href = o
                                                } catch (t) {
                    ...
                    case 8:
                        return t.prev = 8, e.completed(), t.finish(8);
                    case 11:
                    case "end":
                        return t.stop()
                }
