...
(() => {
    ...
    function r() {
        ...
        function P(t, r) {
            function n(o, a, c, u) {
                ...
                if ("throw" !== l.type) {
                    var s = l.arg,
                        f = s.value;
                    return f && "object" == e(f) && i.call(f, "__await") ? r.resolve(f.__await).then((function(t) {
                        n("next", t, c, u)
                    }), (function(t) {
                        n("throw", t, c, u)
        ...
        return b.prototype = x, a(O, "constructor", {
            ...
            return Object.setPrototypeOf ? Object.setPrototypeOf(t, x) : (t.__proto__ = x, f(t, s, "GeneratorFunction")), t.prototype = Object.create(O), t
        }, n.awrap = function(t) {
            return {
                __await: t
            }
        }, _(P.prototype), f(P.prototype, l, (function() {
            return this
        ...
        }, _(O), f(O, s, "Generator"), f(O, u, (function() {
            return this
            ...
            constructor: N,
            reset: function(e) {
                if (this.prev = 0, this.next = 0, this.sent = this._sent = t, this.done = !1, this.delegate = null, this.method = "next", this.arg = t, this.tryEntries.forEach(G), !e)
    ...
    function c() {
        return c = o(r().mark((function e(n) {
            return r().wrap((function(e) {
                for (;;) switch (e.prev = e.next) {
                    case 0:
                        ...
                        return null != n && n.completed && n.completed(), e.abrupt("return");
                    case 3:
                        return i = !0, e.prev = 4, e.next = 7, Excel.run(function() {
                            var e = o(r().mark((function e(n) {
                                var o;
                                return r().wrap((function(e) {
                                    for (;;) switch (e.prev = e.next) {
                                        case 0:
                                            return (o = n.workbook.properties).load("title"), e.next = 4, n.sync();
                                        case 4:
                                            if ("PlanningActuelia" !== o.title) {
                                                e.next = 10;
                                                break
                                            }
                                        ...
                                        case 8:
                                            ...
                                            break;
                                        case 10:
                                            console.log("Autre fichier, ouverture du planning SharePoint."), window.open(t, "_blank");
                                        case 12:
                                        case "end":
                                            return e.stop()
                                    }
                    ...
                    case 7:
                        ...
                        break;
                    case 9:
                        e.prev = 9, e.t0 = e.catch(4), console.error("Erreur dans openPlanningFile:", e.t0), window.open(t, "_blank");
                    case 13:
                        return e.prev = 13, i = !1, null != n && n.completed && n.completed(), e.finish(13);
                    case 17:
                    case "end":
                        return e.stop()
                }
    ...
    Office.onReady((function() {
        ...
        try {
            var t = "".concat("Office.AutoShowTaskpaneWithDocument", "::autoOpenDone");
            sessionStorage.getItem(t) || (sessionStorage.setItem(t, "1"), a())
        } catch (t) {
            a()
        }
