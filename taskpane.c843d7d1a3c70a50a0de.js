/*! For license information please see taskpane.c843d7d1a3c70a50a0de.js.LICENSE.txt */
(() => {
    "use strict";
    var e, t, n, r, o, a = {
            19152: (e, t, n) => {
                ...
                var i = "PlanningActuelia",
                    c = "Office.AutoShowTaskpaneWithDocument";
                Office.onReady((function() {
                    console.log("Complément Planning Actuelia prêt."), Excel.run(function() {
                            ...
                            return o().wrap((function(e) {
                                for (;;) switch (e.prev = e.next) {
                                    ...
                                    case 4:
                                        ...
                                        return e.prev = 5, e.next = 8, Office.addin.showAsTaskpane();
                                    case 8:
                                        e.next = 13;
                                        break;
                                    case 10:
                                        e.prev = 10, e.t0 = e.catch(5), console.error("Impossible d'ouvrir le taskpane :", e.t0);
                                    case 13:
                                        Office.context.document.settings.get(c) || (Office.context.document.settings.set(c, !0), Office.context.document.settings.saveAsync((function(e) {
                                            e.status === Office.AsyncResultStatus.Failed && console.error("Erreur de saveAsync :", e.error.message)
                                        })));
                                    case 15:
                                    case "end":
                                        return e.stop()
                        ...
                        console.error("Erreur lors de l’auto-open :", e)
                    }))
                }))
            },
            14385: e => {
            ...
            60947: (e, t, n) => {
                e.exports = n.p + "88750424d75d19ac29ec.js"
            },
            58394: (e, t, n) => {
    ...
    c.m = a, c.n = e => {
                            ...
                            return e.next = 2, Excel.run(function() {
                                var e = r(t().mark((function e(r) {
                                    ...
                                    return t().wrap((function(e) {
                                        for (;;) switch (e.prev = e.next) {
                                            case 0:
                                                return xe.debug = !1, a = r.workbook, (i = a.worksheets.getItem(n)).protection.unprotect(), c = i.getRange("C".concat(o, ":XFD").concat(o)).getUsedRange(), e.next = 7, c.load("values");
                                            case 7:
                                                return e.next = 9, r.sync();
                                            case 9:
                                                return xe.debug && console.log("Ligne semaine val", c.values.flat()), s = a.names.getItem("Aujourdhui").getRange(), e.next = 13, s.load("values");
                                            case 13:
                                                return e.next = 15, r.sync();
                                            case 15:
                                                if (xe.debug && console.log("Date :", s.values[0][0]), u = s.values[0][0], l = c.values.flat().filter((function(e) {
                                                        return "" !== e
                                                    })), f = l.findIndex((function(e) {
                                                        return e === u
                                                    })) - 2, xe.debug && console.log("Nombre de semaines (colonnes) à masquer", f), !(f >= 0)) {
                                                    e.next = 52;
                                                    break
                                                }
                                            ...
                                            case 29:
                                                if (p = i.getRange("".concat(d.address, ":").concat(g.address)), !xe.debug) {
                                                    e.next = 36;
                                                    break
                                                }
                                            ...
                                            case 40:
                                                if (xe.debug && (console.log("adresse rangeToHide", p.address), console.log("rangetohide.entireColumn", p.entireColumn)), h = i.getRangeByIndexes(0, p.columnIndex, 1, p.columnCount), !xe.debug) {
                                                    e.next = 49;
                                                    break
                                                }
                ...
                return X().wrap((function(e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            ...
                            console.log("🔗 Bouton Ouvrir le planning cliqué"), window.open("ms-excel:ofe|u|https://actuelia.sharepoint.com/:x:/r/sites/Planning/_layouts/15/Doc.aspx?sourcedoc=%7BB2D3EAFD-27C3-4815-A36C-791752E43822%7D&file=Planning%20-%20v11.xlsx&action=default&mobileredirect=true", "_blank"), e.next = 15;
                            break;
                        case 9:
                            ...
                            return e.next = 12, Excel.run(function() {
                                        ...
                                        for (;;) switch (e.prev = e.next) {
                                            ...
                                            case 8:
                                                o = n.values.flat().filter((function(e) {
                                                    return "" !== e
                                                })).length - 1, xe.debug && console.log(n.values.flat()), n.values.flat().includes(0) && (o = 1), xe.debug && console.log("Nb Mission :", o, "nbMissionsMax :", r.value), o < r.value ? (te("sec-userForm-AjoutMission"), document.getElementById("input-text-Mission").value = "", document.getElementById("input-text-Mission").placeholder = "Saisissez un texte", oe("Liste_Encadrant", "dropdown-Mission"), document.getElementById("btn-validate-AjoutMission").addEventListener("click", ne)) : (xe.debug && console.log("Nombre de mission max atteint"), te("sec-userForm-AjoutMissionError"), document.getElementById("btn-validate-AjoutMissionError").addEventListener("click", ne));
                                            case 14:
                                            case "end":
                                                return e.stop()
                                        }
                                ...
                                var e = ee(X().mark((function e(o) {
                                    ...
                                    return X().wrap((function(e) {
                                        for (;;) switch (e.prev = e.next) {
                                            ...
                                            case 35:
                                                o.application.screenUpdating = !0, xe.debug = !0, te("sec-userForm-AjoutMissionOk"), document.getElementById("texte-AjoutMissionOK").innerText = "Nom : " + t + "\nEncadrant : " + n + "\nConsultants : " + r;
                                            case 39:
                                            case "end":
                                                return e.stop()
                                        }
                                    ...
                                    return X().wrap((function(e) {
                                        for (;;) switch (e.prev = e.next) {
                                            ...
                                            case 15:
                                                ...
                                                break;
                                            case 18:
                                                n.application.calculate(), n.application.screenUpdating = !0, xe.debug = !0, te("sec-userForm-SuppressionMissionOk"), document.getElementById("texte-SuppressionMissionOk").innerText = "Nom : " + t;
                                            case 23:
                                            case "end":
                                                return e.stop()
                                        }
                                    ...
                                    return X().wrap((function(e) {
                                        for (;;) switch (e.prev = e.next) {
                                            ...
                                            case 16:
                                                ...
                                                })) + 1, xe.debug && console.log("Nom de la mission :", s.values[0][0], "indexMission", u), l = K(t), e.prev = 19, d = X().mark((function e() {
                                                    var t, n;
                                                    return X().wrap((function(e) {
                                                        for (;;) switch (e.prev = e.next) {
                                                            case 0:
                                            ...
                                            case 59:
                                                r.application.screenUpdating = !0, xe.debug = !0, te("sec-userForm-AffectationMissionOk"), document.getElementById("texte-AffectationMissionOk").innerText = "Consultant(s) ajouté(s) : " + t + "\nConsultant(s) retiré(s) : " + n;
                                            case 63:
                                            case "end":
                                                return e.stop()
                                        }
                                        ...
                                        for (;;) switch (e.prev = e.next) {
                                            ...
                                            case 16:
                                                u = s.values[0][0], l = c.values.flat().findIndex((function(e) {
                                                    return e === u
                                                })) + 1, xe.debug && console.log("Nom de la mission :", u, "indexMission", l), f = K(t), e.prev = 20, g = X().mark((function e() {
                                                    var t, n;
                                                    return X().wrap((function(e) {
                                                        for (;;) switch (e.prev = e.next) {
                                                            case 0:
                                            ...
                                            case 60:
                                                r.application.screenUpdating = !0, xe.debug = !0, te("sec-userForm-AffectationConsultantOk"), document.getElementById("texte-AffectationConsultantOk").innerText = "Mission(s) ajoutée(s) : " + t + "\nMission(s) retirée(s) : " + n;
                                            case 64:
                                            case "end":
                                                return e.stop()
                                        }
        ...
        function ke(e, t) {
            try {
                document.querySelectorAll("section").forEach((function(e) {
                    e.style.display = "none"
                })), console.log("avant boucle :", e, t), "1. Liste des missions" === e ? (console.log("boucle 1 :", e, t), document.getElementById("sec-btn-AjoutMission").style.display = "flex", document.getElementById("sec-btn-Suppression").style.display = "flex") : "2. Planning - Missions" === e ? (console.log("boucle 2 :", e, t), document.getElementById("sec-btn-AjoutMission").style.display = "flex", document.getElementById("sec-btn-Suppression").style.display = "flex", document.getElementById("sec-btn-ModifierAffectationMission").style.display = "flex") : "2. Planning - Consultant" === e ? (console.log("boucle 3 :", e, t), document.getElementById("sec-btn-AjoutMission").style.display = "flex", document.getElementById("sec-btn-Suppression").style.display = "flex", document.getElementById("sec-btn-ModifierAffectationConsultant").style.display = "flex") : t !== pe.x && (console.log("boucle 4 :", e, t), document.getElementById("sec-btn-OpenPlanning").style.display = "flex")
            } catch (e) {
        ...
        function _e() {
            return _e = me(ye().mark((function e() {
                return ye().wrap((function(e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            return e.next = 2, Excel.run(function() {
