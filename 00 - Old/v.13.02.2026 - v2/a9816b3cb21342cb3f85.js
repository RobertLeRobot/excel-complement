/*! For license information please see a9816b3cb21342cb3f85.js.LICENSE.txt */
function _typeof(e) {
...
function _regeneratorRuntime() {
    ...
    var _ = v.prototype = m.prototype = Object.create(x);
    ...
    function S(t, n, r) {
        ...
        return function(i, a) {
            ...
            for (r.method = i, r.arg = a;;) {
                ...
                var l = f(t, n, r);
                if ("normal" === l.type) {
                    if (o = r.done ? h : g, l.arg === y) continue;
                    return {
                        value: l.arg,
                        done: r.done
                    }
    ...
    return b.prototype = v, o(_, "constructor", {
        ...
        value: b,
        configurable: !0
    }), b.displayName = l(v, s, "GeneratorFunction"), t.isGeneratorFunction = function(e) {
        var t = "function" == typeof e && e.constructor;
        return !!t && (t === b || "GeneratorFunction" === (t.displayName || t.name))
    }, t.mark = function(e) {
        return Object.setPrototypeOf ? Object.setPrototypeOf(e, v) : (e.__proto__ = v, l(e, s, "GeneratorFunction")), e.prototype = Object.create(_), e
    }, t.awrap = function(e) {
        return {
            __await: e
        }
...
import {
    PLANNING_TITLE,
    sharepointUrl
} from "../commands/commandsConfig.js";
                        ...
                        var e = _asyncToGenerator(_regeneratorRuntime().mark((function e(t) {
                            ...
                            return _regeneratorRuntime().wrap((function(e) {
                                for (;;) switch (e.prev = e.next) {
                                    ...
                                    case 10:
                                        return r = t.workbook, globalVar.debug && console.log(r), r.worksheets.onActivated.add(handleSheetChange), (o = r.properties).load("title"), i = r.worksheets.getActiveWorksheet(), e.next = 18, i.load("name");
                                    case 18:
                                        return e.next = 20, t.sync();
                                    case 20:
                                        return handleButtonDisplay(i.name, o.title), e.next = 23, t.sync();
                                    case 23:
                    ...
                    return e.next = 2, Excel.run(function() {
                        var e = _asyncToGenerator(_regeneratorRuntime().mark((function e(o) {
                            ...
                            return _regeneratorRuntime().wrap((function(e) {
                                for (;;) switch (e.prev = e.next) {
                                    case 0:
                                        return globalVar.debug = !0, i = o.workbook, a = i.worksheets.getItem("Suivi Modif"), e.next = 5, a.load("name");
                                    case 5:
                                        return c = a.getRange("A:A").getUsedRange(), e.next = 8, c.load("rowCount");
                                    case 8:
                                        return e.next = 10, o.sync();
                                    case 10:
                                        return s = c.rowCount + 1, globalVar.debug && console.log("Nombre de lignes utilisées dans wsSuivi :", s), a.getCell(s - 1, 0).values = [
                                            [t]
                                        ], a.getCell(s - 1, 1).values = [
                                            [n]
                                        ], a.getCell(s - 1, 2).values = [
                                            [r]
                                    ...
                                    case 21:
                                        a.getCell(s - 1, 3).values = [
                                            [l]
                                        ], u = new Date, f = "".concat(String(u.getDate()).padStart(2, "0"), "/").concat(String(u.getMonth() + 1).padStart(2, "0"), "/").concat(u.getFullYear(), " ").concat(String(u.getHours()).padStart(2, "0"), ":").concat(String(u.getMinutes()).padStart(2, "0"), ":").concat(String(u.getSeconds()).padStart(2, "0")), a.getCell(s - 1, 4).values = [
                                            [f]
                    ...
                    return e.next = 2, Excel.run(function() {
                        var e = _asyncToGenerator(_regeneratorRuntime().mark((function e(t) {
                            ...
                            return _regeneratorRuntime().wrap((function(e) {
                                for (;;) switch (e.prev = e.next) {
                                    case 0:
                                        return globalVar.debug = !1, globalVar.debug && console.log("Activation de la feuille 3. Recap"), (n = t.application).screenUpdating = !1, n.calculate(), e.next = 8, formatSemaine("3. Recap", 4);
                                    case 8:
