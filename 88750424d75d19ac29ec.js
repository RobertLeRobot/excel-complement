/*! For license information please see 88750424d75d19ac29ec.js.LICENSE.txt */
function _typeof(e) {
                        ...
                        var e = _asyncToGenerator(_regeneratorRuntime().mark((function e(t) {
                            ...
                            return _regeneratorRuntime().wrap((function(e) {
                                for (;;) switch (e.prev = e.next) {
                                    ...
                                    case 10:
                                        return r = t.workbook, globalVar.debug && console.log(r), r.worksheets.onActivated.add(handleSheetChange), (o = r.properties).load("title"), a = r.worksheets.getActiveWorksheet(), e.next = 18, a.load("name");
                                    case 18:
                                        return e.next = 20, t.sync();
                                    case 20:
                                        return handleButtonDisplay(a.name, o.title), e.next = 23, t.sync();
                                    case 23:
