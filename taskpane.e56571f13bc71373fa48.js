/*! For license information please see taskpane.e56571f13bc71373fa48.js.LICENSE.txt */
(() => {
    "use strict";
    var e, t, n, r, o, a = {
            19152: (e, t, n) => {
                ...
                var c = "PlanningActuelia",
                    s = "ms-excel:ofe|u|https://actuelia.sharepoint.com/:x:/r/sites/Planning-Dev/_layouts/15/Doc.aspx?sourcedoc=%7B92B818C0-9252-468E-B871-0127854FC9F7%7D&file=Planning%20-%20vDev.xlsx&action=default&mobileredirect=true",
                    u = !1;
                ...
                function f() {
                    return f = i(o().mark((function e(t) {
                        return o().wrap((function(e) {
                            for (;;) switch (e.prev = e.next) {
                                case 0:
                                    ...
                                    return null != t && t.completed && t.completed(), e.abrupt("return");
                                case 3:
                                    return u = !0, e.prev = 4, e.next = 7, Excel.run(function() {
                                ...
                                case 7:
                                    ...
                                    break;
                                case 9:
                                    e.prev = 9, e.t0 = e.catch(4), console.error("Erreur dans openPlanningFile:", e.t0), window.open(s, "_blank");
                                case 13:
                                    return e.prev = 13, u = !1, null != t && t.completed && t.completed(), e.finish(13);
                                case 17:
                                case "end":
                                    return e.stop()
                            }
                ...
                Office.onReady((function() {
                    ...
                    try {
                        var e = "".concat("Office.AutoShowTaskpaneWithDocument", "::autoOpenDone");
                        sessionStorage.getItem(e) || (sessionStorage.setItem(e, "1"), l())
                    } catch (e) {
                        l()
                    }
                })), Office.actions.associate("openPlanningFile", l)
            },
            14385: e => {
            ...
            60947: (e, t, n) => {
                e.exports = n.p + "c8ac3583860309c63c77.js"
            },
            58394: (e, t, n) => {
    ...
    c.m = a, c.n = e => {
                ...
                return t().wrap((function(e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            return e.next = 2, Excel.run(function() {
                                var e = r(t().mark((function e(n) {
                                    var r, o, a, i, c, s, u, l, f, d, g, p, h, y, v, m, x, b, w, k, E;
                                    return t().wrap((function(e) {
                                        for (;;) switch (e.prev = e.next) {
                                            case 0:
                                            ...
                                            case 92:
                                                return E = o.getRange(w.address + ":" + k.address), xe.debug && console.log("Plage à cacher :", w.address + ":" + k.address), e.next = 97, E.load("address, rowIndex, rowCount");
                                            case 97:
                                                return e.next = 99, n.sync();
                                            case 99:
                                                xe.debug && (console.log("adresse rangeToHide", E.address), console.log("rangetohide.entireRow", E.entireRow)), o.getRange("".concat(E.rowIndex + 1, ":").concat(E.rowIndex + E.rowCount - 1)).rowHidden = !0;
                                            case 102:
                            ...
                            return e.next = 2, Excel.run(function() {
                                var e = y(p().mark((function e(t) {
                                    ...
                                    return p().wrap((function(e) {
                                        for (;;) switch (e.prev = e.next) {
                                            case 0:
                                                return xe.debug = !0, xe.debug && console.log("Activation de la feuille 2. Planning - Consultant"), (n = t.application).screenUpdating = !1, n.calculate(), e.next = 8, o();
                                            case 8:
                                                return e.next = 10, u();
                                            case 10:
        ...
        function b() {
            return b = y(p().mark((function e(t, n, r) {
                return p().wrap((function(e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            return xe.debug = !0, xe.debug && (console.log("Fonction modifPlanningConsultant exécutée."), console.log("modifPlanningConsultant appelée avec :", t, n, r)), e.next = 5, Excel.run(function() {
                                var e = y(p().mark((function e(o) {
                                    ...
                                    return p().wrap((function(e) {
                                        for (;;) switch (e.prev = e.next) {
                                            ...
                                            case 78:
                                                return XXXXX, xe.debug && console.log("Calcul déclenché après modification de la feuille", i.name), e.next = 83, o.sync();
                                            case 83:
                                                xe.debug = !0;
                                            case 84:
                                            case "end":
        ...
        function k() {
            return k = y(p().mark((function e(t) {
                return p().wrap((function(e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            if (xe.debug = !0, xe.debug && console.log("Fonction ChgtFeuilleConsultant exécutée \nevent :", t), "ThisLocalAddin" != t.triggerSource) {
                                e.next = 9;
                                break
                            }
                            return xe.debug && console.log("Modification stopée car pas demandée par l'utilisateur - avant"), e.abrupt("return");
                        case 9:
                            if (xe.debug && console.log("Modification stopée car pas demandée par l'utilisateur - après boucle"), !xe.isProcessing) {
                                e.next = 15;
                                break
                            }
                            return xe.debug && console.log("Une modification est déjà en cours de traitement. Ignorée."), e.abrupt("return");
                        case 15:
                            return xe.isProcessing = !0, e.next = 18, Excel.run(function() {
                                    ...
                                    return p().wrap((function(e) {
                                        for (;;) switch (e.prev = e.next) {
                                            ...
                                            case 45:
                                                ...
                                                return xe.debug && console.log("Modification détectée dans la plage B2:B3"), n.application.calculate(), e.next = 51, n.sync();
                                            case 51:
                                                return e.next = 53, o();
                                            case 53:
                                                return e.next = 55, u();
                                            case 55:
                                                xe.debug = !0, e.next = 62;
                                                break;
                                            case 58:
                                                e.prev = 58, e.t0 = e.catch(9), xe.debug = !0, console.error("Erreur lors du traitement de la modification : " + e.t0);
                                            case 62:
                                                return e.prev = 62, xe.debug && console.log("Réactivation du gestionnaire onChanged"), c.onChanged.add(w), n.application.calculate(), e.next = 69, n.sync();
                                            case 69:
                                                return e.next = 71, n.sync();
                                            case 71:
                                                return xe.isProcessing = !1, xe.debug = !0, e.finish(62);
                                            case 74:
                                            case "end":
                                                return e.stop()
                                        }
        ...
        function A() {
            return A = C(L().mark((function e(t, n, r) {
                return L().wrap((function(e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                                ...
                                var e = C(L().mark((function e(o) {
                                    ...
                                    return L().wrap((function(e) {
                                        for (;;) switch (e.prev = e.next) {
                                            ...
                                            case 77:
                                                return t.clear(Excel.ClearApplyTo.contents), xe.debug && console.log("Contenu de la plage modifiée supprimé :", t.address), e.next = 82, o.sync();
                                            case 82:
                                                return XXXXX, xe.debug && console.log("Calcul déclenché après modification de la feuille", i.name), e.next = 87, o.sync();
                                            case 87:
                                                xe.debug = !0;
                                            case 88:
                                            case "end":
        ...
        function M() {
            return M = C(L().mark((function e(t) {
                return L().wrap((function(e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            if (xe.debug = !0, xe.debug && console.log("Fonction ChgtFeuilleMission exécutée."), "ThisLocalAddin" != t.triggerSource) {
                                e.next = 7;
                                break
                            }
                            ...
                            return xe.isProcessing = !0, e.next = 14, Excel.run(function() {
                                var e = C(L().mark((function e(n) {
                                    ...
                                    return L().wrap((function(e) {
                                        for (;;) switch (e.prev = e.next) {
                                            case 0:
                                                return xe.debug && console.log("Détection de modification dans la feuille", xe.nbExecModifMission++, "fois"), r = n.workbook, a = r.worksheets.getActiveWorksheet(), c = "2. Planning - Missions", s = n.workbook.worksheets.getItem(c), xe.debug && console.log("Désactivation temporaire du gestionnaire onChanged"), s.onChanged.remove(j), e.prev = 9, e.next = 12, a.load("name");
                                            case 12:
                                                return e.next = 14, n.sync();
                                            case 14:
                                            ...
                                            case 43:
                                                ...
                                                return xe.debug && console.log("Modification détectée dans la plage B2"), n.application.calculate(), e.next = 49, n.sync();
                                            case 49:
                                                return e.next = 51, o();
                                            case 51:
                                                return e.next = 53, i();
                                            ...
                                            case 59:
                                                return e.prev = 59, xe.debug && console.log("Réactivation du gestionnaire onChanged"), s.onChanged.add(j), (g = r.application).load("calculationState"), Excel.run(function() {
                                                    var e = C(L().mark((function e(t) {
                                                        return L().wrap((function(e) {
                                                            for (;;) switch (e.prev = e.next) {
                                                                case 0:
                                            ...
                                            case 68:
                                                return xe.debug && console.log("calculationState =", g.calculationState), xe.debug = !0, xe.isProcessing = !1, e.finish(59);
                                            case 72:
                                            case "end":
                                                return e.stop()
                                        }
        ...
        function N() {
            ...
            return m.prototype = x, o(E, "constructor", {
                ...
                return Object.setPrototypeOf ? Object.setPrototypeOf(e, x) : (e.__proto__ = x, u(e, s, "GeneratorFunction")), e.prototype = Object.create(E), e
            }, t.awrap = function(e) {
                return {
                    __await: e
                }
            ...
            }, L(E), u(E, s, "Generator"), u(E, i, (function() {
                return this
                                    ...
                                    return N().wrap((function(e) {
                                        for (;;) switch (e.prev = e.next) {
                                            ...
                                            case 14:
                                                ...
                                                return xe.debug && console.log("Modification détectée dans la plage B3"), n.application.calculate(), e.next = 23, n.sync();
                                            case 23:
                                                return c = r.names.getItem("Recap_2").getRange(), e.next = 26, n.sync();
                                            case 26:
                                                return s = c.conditionalFormats, e.next = 29, s.load("items");
                                            case 29:
                                            ...
                                            case 33:
                                                ...
                                                return xe.debug && console.log("Traitement du format ".concat(l, " sur ").concat(u)), f = s.getItemAt(l), e.next = 39, n.sync();
                                            case 39:
                                                return xe.debug && (console.log("Format condition", f), console.log("Ancienne plage :", f.address)), f.setRanges(c), e.next = 43, n.sync();
                                            case 43:
                                            ...
                                            case 50:
                                                ...
                                                break;
                                            case 53:
                                                xe.debug = !0, e.next = 60;
                                                break;
                                            case 56:
                                                e.prev = 56, e.t0 = e.catch(9), xe.debug = !0, console.error("Erreur lors du traitement de la modification : " + e.t0);
                                            case 60:
                                                return e.prev = 60, xe.debug && console.log("Réactivation du gestionnaire onChanged"), i.onChanged.add(G), e.next = 66, n.sync();
                                            case 66:
                                                return xe.isProcessing = !1, xe.debug = !0, e.finish(60);
                                            case 69:
                                            case "end":
                                                return e.stop()
                                        }
                            ...
                            return xe.isProcessing = !0, e.next = 10, Excel.run(function() {
                                var e = Y(J().mark((function e(n) {
                                    ...
                                    return J().wrap((function(e) {
                                        for (;;) switch (e.prev = e.next) {
                                            case 0:
                                                return xe.debug && console.log("Détection de modification dans la feuille", xe.nbExecModifEncadrant++, "fois"), r = n.workbook, o = r.worksheets.getActiveWorksheet(), a = "3. Planning - Encadrant", i = n.workbook.worksheets.getItem(a), xe.debug && console.log("Désactivation temporaire du gestionnaire onChanged"), i.onChanged.remove(q), e.prev = 9, e.next = 12, o.load("name");
                                            case 12:
                                                return e.next = 14, n.sync();
                                            case 14:
                                                if (xe.debug && console.log("Feuille active :", o.name), o.name !== a) {
                                                ...
                                                return xe.debug && console.log("Modification détectée dans la plage B2:B3"), n.application.calculate(), e.next = 23, n.sync();
                                            case 23:
                                                return c = r.names.getItem("Recap_3").getRange(), e.next = 26, n.sync();
                                            case 26:
                                                return s = c.conditionalFormats, e.next = 29, s.load("items");
                                            case 29:
                                                return e.next = 31, n.sync();
                                            ...
                                            case 56:
                                                e.prev = 56, e.t0 = e.catch(9), xe.debug = !0, console.error("Erreur lors du traitement de la modification : " + e.t0);
                                            case 60:
                                                return e.prev = 60, xe.debug && console.log("Réactivation du gestionnaire onChanged"), i.onChanged.add(q), e.next = 66, n.sync();
                                            case 66:
                                                return xe.isProcessing = !1, xe.debug = !0, e.finish(60);
                                            case 69:
                                            case "end":
                ...
                return Z().wrap((function(e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            ...
                            console.log("🔗 Bouton Ouvrir le planning cliqué"), window.open(z.X, "_blank"), e.next = 14;
                            break;
                        case 8:
                    ...
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            return xe.debug = !1, xe.debug && console.log("Lancement fonction nouvelleMission"), t = document.getElementById("input-text-Mission").value, n = document.getElementById("dropdown-Mission").value, r = Array.from(document.getElementById("listbox-SelectionConsultant").selectedOptions).map((function(e) {
                                ...
                                var e = te(Z().mark((function e(a) {
                                    var c, s, l, f, d, g, p, h, y;
                                    return Z().wrap((function(e) {
                                        for (;;) switch (e.prev = e.next) {
                                            case 0:
                                                return a.application.screenUpdating = !1, c = a.workbook.worksheets.getActiveWorksheet(), s = a.workbook.worksheets.getItem("1. Liste des missions"), l = a.workbook.worksheets.getItem("Affectation des consultants"), f = a.workbook.names.getItem("Liste_Missions").getRange(), e.next = 7, f.load("values");
                                            case 7:
                                                return d = a.workbook.names.getItem("Nb_Missions_Max"), e.next = 10, d.load("value");
                                            case 10:
                                                return g = a.workbook.names.getItem("Liste_Consultants").getRange(), e.next = 13, g.load("values");
                                            case 13:
                                                return e.next = 15, a.sync();
                                            case 15:
                                                return p = f.values.length + 3, f.values.flat().includes(0) && (p = f.values.flat().findIndex((function(e) {
                                                    return 0 === e
                                                })) + 3), s.protection.unprotect(), e.next = 20, a.sync();
                                            case 20:
                                                return xe.debug && console.log("index nouvelle mission", p), s.getCell(p, 1).values = [
                                                    [t]
                                                ], s.getCell(p, 2).values = [
                                                    [n]
                                                ], e.next = 25, a.sync();
                                            case 25:
                                                h = Z().mark((function e() {
                                                    ...
                                                    return Z().wrap((function(e) {
                                                        for (;;) switch (e.prev = e.next) {
                                                            case 0:
                                                                t = r[y], n = g.values.flat().findIndex((function(e) {
                                                                    return e === t
                                                                })) + 1, xe.debug && console.log("nom :", t, "\nrangeConsultant", g.values.flat(), "indexName :", n), l.getCell(p, n + 2).values = [
                                            ...
                                            case 27:
                                                ...
                                                return e.delegateYield(h(), "t0", 29);
                                            case 29:
                                                y++, e.next = 27;
                                                break;
                                            case 32:
                                                return s.protection.protect(), l.calculate(), e.next = 36, a.sync();
                                            case 36:
                                                if (c.calculate(), "2. Planning - Consultant" !== c.name) {
                                                    e.next = 42;
                                                    break
                                                }
                                                return e.next = 40, u();
                                            ...
                                            case 45:
                                                return e.next = 47, o();
                                            case 47:
                                                a.application.screenUpdating = !0, xe.debug = !0, ne("sec-userForm-AjoutMissionOk"), document.getElementById("texte-AjoutMissionOK").innerText = "Nom : " + t + "\nEncadrant : " + n + "\nConsultants : " + r;
                                            case 51:
                                            case "end":
                                                return e.stop()
                                        }
                            ...
                            return xe.debug = !1, xe.debug && console.log("Lancement fonction suppressionMission"), t = Array.from(document.getElementById("listbox-SuppressionMission").selectedOptions).map((function(e) {
                                ...
                                var e = te(Z().mark((function e(n) {
                                    ...
                                    return Z().wrap((function(e) {
                                        for (;;) switch (e.prev = e.next) {
                                            case 0:
                                                return n.application.screenUpdating = !1, r = n.workbook.worksheets.getActiveWorksheet(), a = n.workbook.worksheets.getItem("Affectation des consultants"), c = n.workbook.worksheets.getItem("1. Liste des missions"), s = n.workbook.names.getItem("Liste_Missions").getRange(), e.next = 7, s.load("values");
                                            case 7:
                                            ...
                                            case 14:
                                                f = Z().mark((function e() {
                                                    ...
                                                    return Z().wrap((function(e) {
                                                        for (;;) switch (e.prev = e.next) {
                                                            case 0:
                                                                return r = t[d], o = s.values.flat().findIndex((function(e) {
                                                                    return e === r
                                                                })) + 1, xe.debug && console.log("Nom mission :", r, "\nindexMission :", o), i = a.getRangeByIndexes(o + 2, 3, 1, l.values.length), e.next = 6, i.load("values");
                                                            case 6:
                                                                return e.next = 8, n.sync();
                                                            case 8:
                                                                ...
                                                                })), xe.debug && console.log("rangeAffectation", i.values.flat(), "\nlsIndex", u, "\nlsConsultants", f), g = K(f), e.prev = 12, g.s();
                                                            case 14:
                                                                if ((p = g.n()).done) {
                                                                    e.next = 33;
                                                                    break
                                                            ...
                                                            case 41:
                                                                return i.values = [Array(l.values.length).fill("")], c.protection.unprotect(), c.getRangeByIndexes(o + 2, 1, 1, 2).values = [Array(2).fill(0)], c.protection.protect(), e.next = 47, n.sync();
                                                            case 47:
                                                            case "end":
                                                                return e.stop()
                                                        }
                                            ...
                                            case 30:
                                                return e.next = 32, o();
                                            case 32:
                                                n.application.screenUpdating = !0, xe.debug = !0, ne("sec-userForm-SuppressionMissionOk"), document.getElementById("texte-SuppressionMissionOk").innerText = "Nom : " + t;
                                            case 36:
                                            case "end":
                                                return e.stop()
                                        }
                    ...
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            return xe.debug = !1, xe.debug && console.log("Lancement fonction affectationMission"), t = Array.from(document.getElementById("listbox-AjouterConsultant").selectedOptions).map((function(e) {
                                ...
                                var e = te(Z().mark((function e(r) {
                                    var a, c, s, u, l, f, d, g, p, h, y, v;
                                    return Z().wrap((function(e) {
                                        for (;;) switch (e.prev = e.next) {
                                            case 0:
                                                return r.application.screenUpdating = !1, a = r.workbook.worksheets.getItem("Affectation des consultants"), c = r.workbook.worksheets.getItem("2. Planning - Missions"), s = r.workbook.names.getItem("Liste_Missions").getRange(), e.next = 6, s.load("values");
                                            case 6:
                                                return u = r.workbook.names.getItem("Liste_Consultants").getRange(), e.next = 9, u.load("values");
                                            case 9:
                                                return e.next = 11, r.sync();
                                            case 11:
                                                return l = c.getCell(1, 1), e.next = 14, l.load("values");
                                            case 14:
                                                return e.next = 16, r.sync();
                                            case 16:
                                                f = s.values.flat().findIndex((function(e) {
                                                    return e === l.values[0][0]
                                                })) + 1, xe.debug && console.log("Nom de la mission :", l.values[0][0], "indexMission", f), d = K(t), e.prev = 19, p = Z().mark((function e() {
                                                    var t, n;
                                                    return Z().wrap((function(e) {
                                                        for (;;) switch (e.prev = e.next) {
                                                            case 0:
                                                                t = g.value, xe.debug && console.log("constName à ajouter", t), n = u.values.flat().findIndex((function(e) {
                                                                    return e === t
                                            ...
                                            case 34:
                                                h = K(n), e.prev = 35, v = Z().mark((function e() {
                                                    var t, n, o, i;
                                                    return Z().wrap((function(e) {
                                                        for (;;) switch (e.prev = e.next) {
                                                            case 0:
                                                                return t = y.value, xe.debug && console.log("constName à suppr", t), n = r.workbook.worksheets.getItem(t), e.next = 5, r.sync();
                                                            case 5:
                                                                return o = n.getRangeByIndexes(f + 5, 4, 1, 78), e.next = 8, o.load("values");
                                                            case 8:
                                                                return e.next = 10, r.sync();
                                                            case 10:
                                                                if (xe.debug && console.log("rangeNbJoursMissions", o.values.flat()), 0 == o.values.flat().filter((function(e) {
                                                                        return "" != e
                                                                    })).length) {
                                                                    e.next = 16;
                                                                    break
                    ...
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            return xe.debug && console.log("Lancement fonction affectationConsultant"), xe.debug && console.log("Lancement fonction affectationMission"), t = Array.from(document.getElementById("listbox-AjouterMission").selectedOptions).map((function(e) {
                                ...
                                var e = te(Z().mark((function e(r) {
                                    var a, i, c, s, l, f, d, g, p, h, y, v, m;
                                    return Z().wrap((function(e) {
                                        for (;;) switch (e.prev = e.next) {
                                            case 0:
                                                return r.application.screenUpdating = !1, a = r.workbook.worksheets.getItem("Affectation des consultants"), i = r.workbook.worksheets.getItem("2. Planning - Consultant"), c = r.workbook.names.getItem("Liste_Missions").getRange(), e.next = 6, c.load("values");
                                            case 6:
                                                return s = r.workbook.names.getItem("Liste_Consultants").getRange(), e.next = 9, s.load("values");
                                            case 9:
                                                return e.next = 11, r.sync();
                                            case 11:
                                            ...
                                            case 14:
                                                return e.next = 16, r.sync();
                                            case 16:
                                                f = l.values[0][0], d = s.values.flat().findIndex((function(e) {
                                                    return e === f
                                                })) + 1, xe.debug && console.log("Nom de la mission :", f, "indexMission", d), g = K(t), e.prev = 20, h = Z().mark((function e() {
                                                    var t, n;
                                                    return Z().wrap((function(e) {
                                                        for (;;) switch (e.prev = e.next) {
                                                            case 0:
                                                                t = p.value, xe.debug && console.log("missionName à ajouter :", t), n = c.values.flat().findIndex((function(e) {
                                                                    return e === t
                                            ...
                                            case 35:
                                                y = K(n), e.prev = 36, m = Z().mark((function e() {
                                                    var t, n, o, i;
                                                    return Z().wrap((function(e) {
                                                        for (;;) switch (e.prev = e.next) {
                                                            case 0:
                                                                return t = v.value, xe.debug && console.log("missionName à suppr", t), n = c.values.flat().findIndex((function(e) {
                                                                    return e === t
                                                            ...
                                                            case 9:
                                                                return e.next = 11, r.sync();
                                                            case 11:
                                                                if (xe.debug && console.log("rangeNbJoursMissions", i.values.flat()), 0 == i.values.flat().filter((function(e) {
                                                                        return "" != e
                                                                    })).length) {
                                                                    e.next = 18;
                                                                    break
                                                                }
                                                                return xe.debug && console.log("val a supprimer"), i.values = [Array(78).fill("")], e.next = 18, r.sync();
                                                            case 18:
                                ...
                                var e = me(ye().mark((function e(t) {
                                    ...
                                    return ye().wrap((function(e) {
                                        for (;;) switch (e.prev = e.next) {
                                            ...
                                            case 10:
                                                return r = t.workbook, xe.debug && console.log(r), e.next = 14, r.worksheets.onActivated.removeAll();
                                            case 14:
                                                return r.worksheets.onActivated.add(we), (o = r.properties).load("title"), a = r.worksheets.getActiveWorksheet(), e.next = 20, a.load("name");
                                            case 20:
                                                return e.next = 22, t.sync();
                                            case 22:
                                                return Ee(a.name, o.title), e.next = 25, t.sync();
                                            case 25:
        ...
        function ke() {
            return ke = me(ye().mark((function e(t) {
                return ye().wrap((function(e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            return e.next = 2, Excel.run(function() {
        ...
        function Ee(e, t) {
            try {
                document.querySelectorAll("section").forEach((function(e) {
                    e.style.display = "none"
                })), console.log("avant boucle :", e, t), "1. Liste des missions" === e ? (console.log("boucle 1 :", e, t), document.getElementById("sec-btn-AjoutMission").style.display = "flex", document.getElementById("sec-btn-Suppression").style.display = "flex") : "2. Planning - Missions" === e ? (console.log("boucle 2 :", e, t), document.getElementById("sec-btn-AjoutMission").style.display = "flex", document.getElementById("sec-btn-Suppression").style.display = "flex", document.getElementById("sec-btn-ModifierAffectationMission").style.display = "flex") : "2. Planning - Consultant" === e ? (console.log("boucle 3 :", e, t), document.getElementById("sec-btn-AjoutMission").style.display = "flex", document.getElementById("sec-btn-Suppression").style.display = "flex", document.getElementById("sec-btn-ModifierAffectationConsultant").style.display = "flex") : t !== z.x && (console.log("boucle 4 :", e, t), document.getElementById("sec-btn-OpenPlanning").style.display = "flex")
            } catch (e) {
        ...
        function Oe() {
            return Oe = me(ye().mark((function e() {
                return ye().wrap((function(e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            return e.next = 2, Excel.run(function() {
                ...
                var e = me(ye().mark((function e(t) {
                    ...
                    return ye().wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            ...
                            case 6:
                                return xe.debug && console.log("Ajout des gestionnaires de changement pour les feuilles '1. Liste des missions', '2. Planning - Consultant', '2. Planning - Missions', '3. Planning - Encadrant, '3. Planning - Global' et '3. Recap'"), r = t.workbook.worksheets.getItem("2. Planning - Consultant"), e.next = 11, r.onActivated.removeAll();
                            case 11:
                                return r.onActivated.add(v), e.next = 14, r.onChanged.removeAll();
                            case 14:
                                return r.onChanged.add(w), xe.debug && console.log("Chargement des fonctions de la feuille", r), o = t.workbook.worksheets.getItem("2. Planning - Missions"), e.next = 20, o.onActivated.removeAll();
                            case 20:
                                return o.onActivated.add(O), e.next = 23, o.onChanged.removeAll();
                            case 23:
                                return o.onChanged.add(j), xe.debug && console.log("Chargement des fonctions de la feuille", o), a = t.workbook.worksheets.getItem("3. Planning - Encadrant"), e.next = 29, a.onActivated.removeAll();
                            case 29:
                                return a.onActivated.add(W), e.next = 32, a.onChanged.removeAll();
                            case 32:
                                return a.onChanged.add(q), xe.debug && console.log("Chargement des fonctions de la feuille", a), i = t.workbook.worksheets.getItem("3. Planning - Global"), e.next = 38, i.onActivated.removeAll();
                            case 38:
                                return i.onActivated.add(B), e.next = 41, i.onChanged.removeAll();
                            case 41:
                                return i.onChanged.add(G), xe.debug && console.log("Chargement des fonctions de la feuille", i), c = t.workbook.worksheets.getItem("3. Recap"), e.next = 47, c.onActivated.removeAll();
                            case 47:
                                return c.onActivated.add(Ce), xe.debug && console.log("Chargement des fonctions de la feuille", c), s = t.workbook.worksheets.getItem("1. Liste des missions"), e.next = 53, s.onActivated.removeAll();
                            case 53:
                                s.onActivated.add(_e), xe.debug && console.log("Chargement des fonctions de la feuille", s), xe.debug && console.log("Gestionnaire de changement ajouté.");
                            case 58:
                            case "end":
                                return e.stop()
                        }
