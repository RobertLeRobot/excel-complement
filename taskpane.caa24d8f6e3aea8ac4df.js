/*! For license information please see taskpane.caa24d8f6e3aea8ac4df.js.LICENSE.txt */
(() => {
    "use strict";
    var e, t, n, r, o, a = {
            14385: e => {
            ...
            60947: (e, t, n) => {
                e.exports = n.p + "236c3881d5d2a5e7dc94.js"
            },
            58394: (e, t, n) => {
    ...
    c.m = a, c.n = e => {
                                ...
                                var e = r(t().mark((function e(n) {
                                    ...
                                    return t().wrap((function(e) {
                                        for (;;) switch (e.prev = e.next) {
                                            ...
                                            case 19:
                                                return s = "B".concat(a.rowIndex + 1, ":").concat(i.address), me.debug && (console.log("modifMissionsRange :", a.address), console.log("globalVar.debug sRange: ", s)), u = o.getRange(s), e.next = 24, u.load("address");
                                            case 24:
                                            ...
                                            case 92:
                                                return k = o.getRange(w.address + ":" + E.address), me.debug && console.log("Plage à cacher :", w.address + ":" + E.address), e.next = 97, k.load("address, rowIndex, rowCount");
                                            case 97:
                                                return e.next = 99, n.sync();
                                            case 99:
                                                me.debug && (console.log("adresse rangeToHide", k.address), console.log("rangetohide.entireRow", k.entireRow)), o.getRange("".concat(k.rowIndex + 1, ":").concat(k.rowIndex + k.rowCount - 1)).rowHidden = !0;
                                            case 102:
                                ...
                                var e = r(t().mark((function e(n) {
                                    ...
                                    return t().wrap((function(e) {
                                        for (;;) switch (e.prev = e.next) {
                                            ...
                                            case 20:
                                                return s = "B".concat(a.rowIndex + 1, ":").concat(c.address), me.debug && (console.log("modifMissionsRange :", a.address), console.log("globalVar.debug sRange: ", s)), u = o.getRange(s), e.next = 25, u.load("address");
                                            case 25:
                            ...
                            return e.next = 2, Excel.run(function() {
                                var e = r(t().mark((function e(r) {
                                    ...
                                    return t().wrap((function(e) {
                                        for (;;) switch (e.prev = e.next) {
                                            case 0:
                                                return me.debug = !1, a = r.workbook, (i = a.worksheets.getItem(n)).protection.unprotect(), c = i.getRange("C".concat(o, ":XFD").concat(o)).getUsedRange(), e.next = 7, c.load("values");
                                            case 7:
                                            ...
                                            case 15:
                                                if (me.debug && console.log("Date :", s.values[0][0]), u = s.values[0][0], l = c.values.flat().filter((function(e) {
                                                        return "" !== e
                                                    })), f = l.findIndex((function(e) {
                                                        return e === u
                                                    })) - 2, me.debug && console.log("Nombre de semaines (colonnes) à masquer", f), !(f >= 0)) {
                                                    e.next = 52;
                                                    break
                                                }
                                            ...
                                            case 40:
                                                if (me.debug && (console.log("adresse rangeToHide", p.address), console.log("rangetohide.entireColumn", p.entireColumn)), h = i.getRangeByIndexes(0, p.columnIndex, 1, p.columnCount), !me.debug) {
                                                    e.next = 49;
                                                    break
                                                }
                            ...
                            return e.next = 2, Excel.run(function() {
                                var e = y(p().mark((function e(t) {
                                    ...
                                    return p().wrap((function(e) {
                                        for (;;) switch (e.prev = e.next) {
                                            case 0:
                                                return me.debug = !1, me.debug && console.log("Activation de la feuille 2. Planning - Consultant"), (n = t.application).screenUpdating = !1, n.calculate(), e.next = 8, o();
                                            case 8:
                                                return e.next = 10, u();
                                            case 10:
        ...
        function b() {
            return b = y(p().mark((function e(t, n, r) {
                return p().wrap((function(e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            return me.debug = !1, me.debug && (console.log("Fonction modifPlanningConsultant exécutée."), console.log("modifPlanningConsultant appelée avec :", t, n, r)), e.next = 5, Excel.run(function() {
                                var e = y(p().mark((function e(o) {
                                    var a, i, c, s, u, l, f, d, g, h, y, v, m, x, b, w;
                                    return p().wrap((function(e) {
                                        for (;;) switch (e.prev = e.next) {
                                            case 0:
                                                return me.debug && console.log("Début de la fonction modifPlanningConsultant"), a = o.workbook, i = a.worksheets.getActiveWorksheet(), c = a.names.getItemOrNullObject("Nb_Missions_Max"), e.next = 7, i.load("name");
                                            case 7:
                                            ...
                                            case 20:
                                                return me.debug && (console.log("Feuille de calcul chargée :", i.name), console.log("Valeur de Nb_Missions_Max :", s), console.log("Adresse de la plage modifiée :", t), console.log("Numéro de la première ligne modifiée :", n + 1)), u = i.getRange("B2"), e.next = 24, u.load("values");
                                            case 24:
        ...
        function E() {
            return E = y(p().mark((function e(t) {
                return p().wrap((function(e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            if (me.debug = !1, me.debug && console.log("Fonction ChgtFeuilleConsultant exécutée \nevent :", t), "ThisLocalAddin" != t.triggerSource) {
                                e.next = 7;
                                break
                            }
                            ...
                            return me.isProcessing = !0, e.next = 14, Excel.run(function() {
                                var e = y(p().mark((function e(n) {
                                    ...
                                    return p().wrap((function(e) {
                                        for (;;) switch (e.prev = e.next) {
                                            case 0:
                                                return me.debug && console.log("Détection de modification dans la feuille", me.nbExecModifConsultant++, "fois"), r = n.workbook, a = r.worksheets.getActiveWorksheet(), i = "2. Planning - Consultant", c = n.workbook.worksheets.getItem(i), me.debug && console.log("Désactivation temporaire du gestionnaire onChanged"), c.onChanged.remove(w), e.prev = 9, e.next = 12, a.load("name");
                                            case 12:
                                                return e.next = 14, n.sync();
                                            case 14:
                                            ...
                                            case 25:
                                                return e.next = 27, n.sync();
                                            case 27:
                                                if (f = s.rowIndex >= l.rowIndex && s.rowIndex + s.rowCount <= l.rowIndex + l.rowCount && s.columnIndex >= l.columnIndex && s.columnIndex + s.columnCount <= l.columnIndex + l.columnCount, me.debug && console.log("Flag Modif dans le tableau :", f), !f) {
                                                    e.next = 44;
                                                    break
                                                }
                                            ...
                                            case 44:
                                                ...
                                                return me.debug && console.log("Modification détectée dans la plage B2:B3"), e.next = 49, Excel.run(function() {
                                                    var e = y(p().mark((function e(t) {
                                                        return p().wrap((function(e) {
                                                            for (;;) switch (e.prev = e.next) {
                                                                case 0:
                            ...
                            return me.debug = !1, me.debug && (console.log("Fonction modifPlanningMission exécutée."), console.log("modifPlanningMission appelée avec :", t, n, r)), e.next = 4, Excel.run(function() {
                                var e = C(L().mark((function e(o) {
                                    ...
                                    return L().wrap((function(e) {
                                        for (;;) switch (e.prev = e.next) {
                                            case 0:
                                                return me.debug && console.log("Début de la fonction modifPlanningMission"), a = o.workbook, i = a.worksheets.getActiveWorksheet(), c = a.names.getItemOrNullObject("Nb_Missions_Max"), e.next = 7, i.load("name");
                                            case 7:
                                                return e.next = 9, c.load("value");
                                            case 9:
                                                return e.next = 11, o.sync();
                                            ...
                                            case 77:
                                                return t.clear(Excel.ClearApplyTo.contents), me.debug && console.log("Contenu de la plage modifiée supprimé :", t.address), me.debug && console.log("Calcul déclenché après modification de la feuille", i.name), e.next = 84, o.sync();
                                            case 84:
                                                me.debug = !0;
                                            case 85:
                                            case "end":
        ...
        function A() {
            return A = C(L().mark((function e(t) {
                return L().wrap((function(e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            if (me.debug = !1, me.debug && console.log("Fonction ChgtFeuilleMission exécutée."), "ThisLocalAddin" != t.triggerSource) {
                                e.next = 7;
                                break
                            }
                            return me.debug && console.log("Modification stopée car pas demandée par l'utilisateur"), e.abrupt("return");
                            ...
                            return me.isProcessing = !0, e.next = 14, Excel.run(function() {
                                var e = C(L().mark((function e(n) {
                                    ...
                                    return L().wrap((function(e) {
                                        for (;;) switch (e.prev = e.next) {
                                            case 0:
                                                return me.debug && console.log("Détection de modification dans la feuille", me.nbExecModifMission++, "fois"), r = n.workbook, a = r.worksheets.getActiveWorksheet(), c = "2. Planning - Missions", s = n.workbook.worksheets.getItem(c), me.debug && console.log("Désactivation temporaire du gestionnaire onChanged"), s.onChanged.remove(j), e.prev = 9, e.next = 12, a.load("name");
                                            case 12:
                                                return e.next = 14, n.sync();
                                            case 14:
                                            ...
                                            case 42:
                                                ...
                                                return me.debug && console.log("Modification détectée dans la plage B2"), e.next = 47, Excel.run(function() {
                                                    var e = C(L().mark((function e(t) {
                                                        return L().wrap((function(e) {
                                                            for (;;) switch (e.prev = e.next) {
                                                                case 0:
                                    ...
                                    return P().wrap((function(e) {
                                        for (;;) switch (e.prev = e.next) {
                                            ...
                                            case 16:
                                                ...
                                                return me.debug && console.log("Traitement du format ".concat(i, " sur ").concat(a)), c = o.getItemAt(i), e.next = 22, t.sync();
                                            case 22:
                                                return me.debug && (console.log("Format condition", c), console.log("Ancienne plage :", c.address)), c.setRanges(r), e.next = 26, t.sync();
                                            case 26:
                                    ...
                                    return P().wrap((function(e) {
                                        for (;;) switch (e.prev = e.next) {
                                            ...
                                            case 14:
                                                ...
                                                return me.debug && console.log("Modification détectée dans la plage B3"), e.next = 22, Excel.run(function() {
                                                    var e = F(P().mark((function e(t) {
                                                        return P().wrap((function(e) {
                                                            for (;;) switch (e.prev = e.next) {
                                                                case 0:
        ...
        function W() {
            return W = D(J().mark((function e() {
                return J().wrap((function(e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            return e.next = 2, Excel.run(function() {
                                var e = D(J().mark((function e(t) {
                                    var n, r, o, a, i, c, s;
                                    return J().wrap((function(e) {
                                        for (;;) switch (e.prev = e.next) {
                                            case 0:
        ...
        function z() {
            return z = D(J().mark((function e(t) {
                return J().wrap((function(e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                                    ...
                                    return J().wrap((function(e) {
                                        for (;;) switch (e.prev = e.next) {
                                            ...
                                            case 14:
                                                ...
                                                return me.debug && console.log("Modification détectée dans la plage B2:B3"), e.next = 22, Excel.run(function() {
                                                    var e = D(J().mark((function e(t) {
                                                        return J().wrap((function(e) {
                                                            for (;;) switch (e.prev = e.next) {
                                                                case 0:
        ...
        function re() {
            return re = ee(X().mark((function e(t) {
                var n, r, o;
                return X().wrap((function(e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            if (me.debug = !1, n = t.target.id, me.debug && console.log("Id du bouton :", n), "btn-AjoutMission" != n) {
                                e.next = 8;
                                break
                            }
                            return e.next = 6, Excel.run(function() {
                                var e = ee(X().mark((function e(t) {
                                    var n, r, o;
                                    return X().wrap((function(e) {
                                        for (;;) switch (e.prev = e.next) {
                                            case 0:
        ...
        function ae() {
            return ae = ee(X().mark((function e(t, n) {
                return X().wrap((function(e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            return e.prev = 0, e.next = 3, Excel.run(function() {
                                var e = ee(X().mark((function e(r) {
                                    var o, a, i;
                                    return X().wrap((function(e) {
                                        for (;;) switch (e.prev = e.next) {
                                            case 0:
        ...
        function ce() {
            return ce = ee(X().mark((function e() {
                var t, n, r;
                return X().wrap((function(e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                                ...
                                var e = ee(X().mark((function e(o) {
                                    ...
                                    return X().wrap((function(e) {
                                        for (;;) switch (e.prev = e.next) {
                                            ...
                                            case 19:
                                                return me.debug && console.log("index nouvelle mission", l), a.getCell(l, 1).values = [
                                                    [t]
                                            ...
                                            case 35:
                                                o.application.screenUpdating = !0, me.debug = !0, te("sec-userForm-AjoutMissionOk"), document.getElementById("texte-AjoutMissionOK").innerText = "Nom : " + t + "\nEncadrant : " + n + "\nConsultants : " + r;
                                            case 39:
                                            case "end":
                                                return e.stop()
                                        }
        ...
        function ue() {
            return ue = ee(X().mark((function e() {
                var t;
                return X().wrap((function(e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                                    ...
                                    return X().wrap((function(e) {
                                        for (;;) switch (e.prev = e.next) {
                                            ...
                                            case 15:
                                                ...
                                                break;
                                            case 18:
                                                n.application.calculate(), n.application.screenUpdating = !0, me.debug = !0, te("sec-userForm-SuppressionMissionOk"), document.getElementById("texte-SuppressionMissionOk").innerText = "Nom : " + t;
                                            case 23:
                                            case "end":
                                                return e.stop()
                                        }
        ...
        function fe() {
            return fe = ee(X().mark((function e() {
                var t, n;
                return X().wrap((function(e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                                    ...
                                    return X().wrap((function(e) {
                                        for (;;) switch (e.prev = e.next) {
                                            ...
                                            case 16:
                                                ...
                                                })) + 1, me.debug && console.log("Nom de la mission :", s.values[0][0], "indexMission", u), l = K(t), e.prev = 19, d = X().mark((function e() {
                                                    var t, n;
                                                    return X().wrap((function(e) {
                                                        for (;;) switch (e.prev = e.next) {
                                                            case 0:
                                                                t = f.value, me.debug && console.log("constName à ajouter", t), n = c.values.flat().findIndex((function(e) {
                                                                    return e === t
                                            ...
                                            case 34:
                                                g = K(n), e.prev = 35, h = X().mark((function e() {
                                                    var t, n, a, i;
                                                    return X().wrap((function(e) {
                                                        for (;;) switch (e.prev = e.next) {
                                                            case 0:
                                                                return t = p.value, me.debug && console.log("constName à suppr", t), n = r.workbook.worksheets.getItem(t), e.next = 5, r.sync();
                                                            case 5:
                                                                return a = n.getRangeByIndexes(u + 5, 4, 1, 78), e.next = 8, a.load("values");
                                                            case 8:
                                                                return e.next = 10, r.sync();
                                                            case 10:
                                                                if (me.debug && console.log("rangeNbJoursMissions", a.values.flat()), 0 == a.values.flat().filter((function(e) {
                                                                        return "" != e
                                                                    })).length) {
                                                                    e.next = 16;
                                                                    break
        ...
        function ge() {
            return ge = ee(X().mark((function e() {
                var t, n;
                return X().wrap((function(e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                                        ...
                                        for (;;) switch (e.prev = e.next) {
                                            ...
                                            case 16:
                                                u = s.values[0][0], l = c.values.flat().findIndex((function(e) {
                                                    return e === u
                                                })) + 1, me.debug && console.log("Nom de la mission :", u, "indexMission", l), f = K(t), e.prev = 20, g = X().mark((function e() {
                                                    var t, n;
                                                    return X().wrap((function(e) {
                                                        for (;;) switch (e.prev = e.next) {
                                                            case 0:
                                                                t = d.value, me.debug && console.log("missionName à ajouter :", t), n = i.values.flat().findIndex((function(e) {
                                                                    return e === t
                                            ...
                                            case 35:
                                                p = K(n), e.prev = 36, y = X().mark((function e() {
                                                    var t, n, a, c;
                                                    return X().wrap((function(e) {
                                                        for (;;) switch (e.prev = e.next) {
                                                            case 0:
                                                                return t = h.value, me.debug && console.log("missionName à suppr", t), n = i.values.flat().findIndex((function(e) {
                                                                    return e === t
                                                            ...
                                                            case 9:
                                                                return e.next = 11, r.sync();
                                                            case 11:
                                                                if (me.debug && console.log("rangeNbJoursMissions", c.values.flat()), 0 == c.values.flat().filter((function(e) {
                                                                        return "" != e
                                                                    })).length) {
                                                                    e.next = 18;
                                                                    break
                                ...
                                var e = ve(he().mark((function e(o) {
                                    ...
                                    return he().wrap((function(e) {
                                        for (;;) switch (e.prev = e.next) {
                                            ...
                                            case 10:
                                                return s = c.rowCount + 1, me.debug && console.log("Nombre de lignes utilisées dans wsSuivi :", s), i.getCell(s - 1, 0).values = [
                                                    [t]
                                            ...
                                            case 21:
                                                i.getCell(s - 1, 3).values = [
                                                    ...
                                                    [f]
                                                ], me.debug && console.log("Informations de suivi ajoutées pour la ligne :", s), me.debug = !0;
                                            case 28:
                                            case "end":
                                                return e.stop()
                                        }
                            ...
                            return e.next = 2, Excel.run(function() {
                                var e = ve(he().mark((function e(t) {
                                    ...
                                    return he().wrap((function(e) {
                                        for (;;) switch (e.prev = e.next) {
                                            case 0:
                                                return me.debug = !1, me.debug && console.log("Activation de la feuille 3. Recap"), (n = t.application).screenUpdating = !1, n.calculate(), e.next = 8, f("3. Recap", 3);
                                            case 8:
        ...
        function Se() {
            return Se = ve(he().mark((function e() {
                return he().wrap((function(e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            return e.next = 2, Excel.run(function() {
        ...
        me.debug && console.log(me.isProcessing), Office.onReady((function(e) {
                ...
                var e = ve(he().mark((function e(t) {
                    ...
                    return he().wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            ...
                            case 6:
                                me.debug && console.log("Ajout des gestionnaires de changement pour les feuilles '1. Liste des missions', '2. Planning - Consultant', '2. Planning - Missions', '3. Planning - Encadrant, '3. Planning - Global' et '3. Recap'"), (r = t.workbook.worksheets.getItem("2. Planning - Consultant")).onActivated.add(v), r.onChanged.add(w), me.debug && console.log("Chargement des fonctions de la feuille", r), (o = t.workbook.worksheets.getItem("2. Planning - Missions")).onActivated.add(O), o.onChanged.add(j), me.debug && console.log("Chargement des fonctions de la feuille", o), (a = t.workbook.worksheets.getItem("3. Planning - Encadrant")).onActivated.add(q), a.onChanged.add(H), me.debug && console.log("Chargement des fonctions de la feuille", a), (i = t.workbook.worksheets.getItem("3. Planning - Global")).onActivated.add(B), i.onChanged.add(G), me.debug && console.log("Chargement des fonctions de la feuille", i), (c = t.workbook.worksheets.getItem("3. Recap")).onActivated.add(Ie), me.debug && console.log("Chargement des fonctions de la feuille", c), (s = t.workbook.worksheets.getItem("1. Liste des missions")).onActivated.add(Oe), me.debug && console.log("Chargement des fonctions de la feuille", s), me.debug && console.log("Gestionnaire de changement ajouté.");
                            case 38:
                            case "end":
                                return e.stop()
                        }
            ...
            })), document.getElementById("btn-AjoutMission").addEventListener("click", ne), document.getElementById("btn-Suppression").addEventListener("click", ne), document.getElementById("btn-ModifierAffectationMission").addEventListener("click", ne), document.getElementById("btn-ModifierAffectationConsultant").addEventListener("click", ne), document.querySelectorAll('[id*="btn-return"]').forEach((function(e) {
